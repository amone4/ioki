<?php require_once APPROOT . '/views/inc/header.php'; ?>
	...
	<div class="row">
		<div class="col-10 offset-1 col-md-6 offset-md-3 card">
			...
			<form method="post" action="<?php echo URLROOT; ?>/users_new" class="col-sm-10 offset-sm-1 card-body small">
				<div class="field">
				...
				<div class="col-md-8 offset-md-2 text-center">
					<a href="<?php echo URLROOT; ?>/users_new/register">Register</a> |
					<a href="<?php echo URLROOT; ?>/users_new/password/forgot">Forgot password</a>
				</div>
			</form>
