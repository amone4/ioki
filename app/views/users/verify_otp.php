<?php require_once APPROOT . '/views/inc/header.php'; ?>
	...
	<div class="row">
		<div class="col-10 offset-1 col-md-6 offset-md-3 card">
			<h2 class="text-center card-title">Verfify Phone Number</h2>
			<form action="<?php echo URLROOT; ?>/users/verifyOTP" method="post" class="col-sm-10 offset-sm-1 card-body small">
