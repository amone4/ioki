...
<head>
	...
	<link rel="stylesheet" href="<?php echo URLROOT; ?>/vendor/fontawesome/css/fa-svg-with-js.css">
	<script src="<?php echo URLROOT; ?>/vendor/fontawesome/js/fontawesome-all.min.js"></script>
